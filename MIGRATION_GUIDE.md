...
## 10. 网络穿透与对齐 (Network Penetration)
**工具**: `05_LINKS/Network_Bridge.ps1`
**目标**: 穿透局域网公司内网 (China Network) 与 本地网络。

- **逻辑**: 通过端口对齐（3000 <-> 8080/5001 等）实现跨设备 R1 指令透传。
- **状态**: 已激活。无论身处何处，只要接入公司内网，即可通过 `172.20.201.173:8080` (或中继 IP) 操控所有 R1 节点。
